...
def gaborOrientations(orig_img, blk_size = 32, gabor_size = 12, n_orientations = 16):
...
if __name__ == "__main__":
    orig_img = cv2.imread('img.jpg', cv2.IMREAD_GRAYSCALE)
    #gaborOrientations(orig_img, 16, 12, 16)
